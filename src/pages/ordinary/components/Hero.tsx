...
const Hero: React.FC = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              Hire Freelancers on the <br /> Workason Marketplace
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed max-w-lg">
              Post a job and receive proposals from freelancers across video editing
              and virtual assistance. Review profiles, chat securely, and hire with
              confidence using our escrow system.
            </p>
  ...
  />
                <div>
                  ...
                  <div className="text-xs text-gray-500">Virtual Assitant</div>
                </div>
              </div>
              <div className="text-xs text-gray-600 space-y-1">
                <div>Experience: 7 years</div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-16 text-center">
        <p className="text-xl text-gray-600">
          More than{" "}
          <span className="text-green-600 font-bold text-2xl">100</span>{" "}
