    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 mt-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
              {employersSmartStart.emp_ss_heading}
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed max-w-lg">
              {employersSmartStart.emp_ss_description}
            </p>
            <button
              onClick={() => navigate(employersSmartStart.emp_ss_button_url)}
            ...
            >
              {employersSmartStart.emp_ss_button}
            </button>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-16 text-center">
        <p className="text-xl text-gray-600">
          More than{" "}
          <span className="text-green-600 font-bold text-2xl">{employersSmartStart.emp_ss_stats_count}</span>{" "}
          {employersSmartStart.emp_ss_stats_text}
        </p>
      </div>
    </div>
  );
