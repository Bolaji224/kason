...
const DisputeResolution: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.employerName.trim())
      newErrors.employerName = "Employer name or username is required";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append("user_type", "candidate");
      payload.append("full_name", formData.fullName);
      payload.append("email", formData.email);
      payload.append("phone", formData.phone);
      payload.append("employer_name", formData.employerName);
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center p-6 min-h-screen bg-gray-50 lg:ml-64">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Enter the employer's name or username"
                />
                {errors.employerName && (
                  <span className="text-red-500 text-sm">{errors.employerName}</span>
                )}
              </div>
